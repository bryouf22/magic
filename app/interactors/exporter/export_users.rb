    ...
    builder = Nokogiri::XML::Builder.new do |xml|
      xml.root do
        User.find_each do |user|
          xml.user(email: user.email, encrypted_password: user.encrypted_password, reset_password_token: user.reset_password_token, reset_password_sent_at: user.reset_password_sent_at, remember_created_at: user.remember_created_at, created_at: user.created_at, updated_at: user.updated_at, nickname: user.nickname, avatar: user.avatar, presentation: user.presentation) do
            xml.card_collection do
            ...
            user.wishlists.each do |wishlist|
              xml.wishlist(name: wishlist.name) do
            ...
            user.decks.each do |deck|
              xml.deck(name: deck.name, status: deck.status, is_public: deck.is_public?, description: deck.description, category: deck.category&.name) do
